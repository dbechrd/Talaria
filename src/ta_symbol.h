...
extern const char *SYM_U_LIGHTS_CAST_SHADOWS[TA_LIGHTING_MAX_ACTIVE_LIGHTS];
extern const char *SYM_U_LIGHTS_COLOR[TA_LIGHTING_MAX_ACTIVE_LIGHTS];
extern const char *SYM_U_LIGHTS_COUNT;
extern const char *SYM_U_LIGHTS_DIRECTION[TA_LIGHTING_MAX_ACTIVE_LIGHTS];
extern const char *SYM_U_LIGHTS_INTENSITY[TA_LIGHTING_MAX_ACTIVE_LIGHTS];
extern const char *SYM_U_LIGHTS_LIGHT_PV[TA_LIGHTING_MAX_ACTIVE_LIGHTS];
extern const char *SYM_U_LIGHTS_POSITION[TA_LIGHTING_MAX_ACTIVE_LIGHTS];
extern const char *SYM_U_LIGHTS_SHADOWMAP_ZFAR[TA_LIGHTING_MAX_ACTIVE_LIGHTS];
extern const char *SYM_U_LIGHTS_SHADOWMAP_TEXTURE_POOL_INDEX[TA_LIGHTING_MAX_ACTIVE_LIGHTS];
extern const char *SYM_U_LIGHTS_SHADOWMAP_TEXTURE_ARRAY_LAYERS[TA_LIGHTING_MAX_ACTIVE_LIGHTS];
extern const char *SYM_U_LIGHTS_TYPE[TA_LIGHTING_MAX_ACTIVE_LIGHTS];
