...
extern const char *SYM_U_LIGHTS_CAST_SHADOWS[TA_LIGHT_MAX_ACTIVE_LIGHTS];
extern const char *SYM_U_LIGHTS_COLOR[TA_LIGHT_MAX_ACTIVE_LIGHTS];
extern const char *SYM_U_LIGHTS_COUNT;
extern const char *SYM_U_LIGHTS_DIRECTION[TA_LIGHT_MAX_ACTIVE_LIGHTS];
extern const char *SYM_U_LIGHTS_INTENSITY[TA_LIGHT_MAX_ACTIVE_LIGHTS];
extern const char *SYM_U_LIGHTS_LIGHT_PV[TA_LIGHT_MAX_ACTIVE_LIGHTS];
extern const char *SYM_U_LIGHTS_POSITION[TA_LIGHT_MAX_ACTIVE_LIGHTS];
extern const char *SYM_U_LIGHTS_SHADOWMAP_ZFAR[TA_LIGHT_MAX_ACTIVE_LIGHTS];
extern const char *SYM_U_LIGHTS_SHADOWMAP_TEXTURE_POOL_INDEX[TA_LIGHT_MAX_ACTIVE_LIGHTS];
extern const char *SYM_U_LIGHTS_SHADOWMAP_TEXTURE_ARRAY_LAYERS[TA_LIGHT_MAX_ACTIVE_LIGHTS];
extern const char *SYM_U_LIGHTS_TYPE[TA_LIGHT_MAX_ACTIVE_LIGHTS];
