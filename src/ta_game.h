...
void *ta_game_by_name(enum ta_resource_type type, const char *name, size_t name_len);
void *ta_game_by_name_try(enum ta_resource_type type, const char *name, size_t name_len);
void *ta_game_by_name_or_default(enum ta_resource_type type, const char *name, size_t name_len);
