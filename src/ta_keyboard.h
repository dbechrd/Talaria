...
void ta_keybind_bind1(enum ta_game_state state_type, enum ta_event_type event_type,
    u32 triggers, ta_key key1);
void ta_keybind_bind2(enum ta_game_state state_type, enum ta_event_type event_type,
    u32 triggers, ta_key key1, ta_key key2);
void ta_keybind_bind3(enum ta_game_state state_type, enum ta_event_type event_type,
