...
void ta_window_set_size             (struct ta_window *window, int w, int h);
...
void ta_window_set_mouse_captured   (struct ta_window *window, bool captured);
void ta_window_update_cursor        (struct ta_window *window);
void ta_window_swap                 (struct ta_window *window);
int ta_window_msgbox                (struct ta_window *window, u32 flags, const char *title, const char *message);