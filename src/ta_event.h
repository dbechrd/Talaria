...
typedef enum ta_event_type {
    ...
    TA_EVENT_DEBUG_MOUSE_LOCK,
    TA_EVENT_DEBUG_MOUSE_UNLOCK,
    TA_EVENT_DEBUG_MOUSE_LOCK_TOGGLE,
    ...
    TA_EVENT_EDITOR_SIM_PAUSE,
    TA_EVENT_EDITOR_SIM_RESUME,
    TA_EVENT_EDITOR_SIM_NEXT,
    TA_EVENT_EDITOR_SIM_NEXT_10,
    TA_EVENT_EDITOR_SIM_WHILE_HELD,
