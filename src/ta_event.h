...
typedef enum {
    ...
    // Player events
    TA_EVENT_PLAYER_MOVE_FORWARD = TA_EVENT_TYPE_FIRST(TA_EVENT_QUEUE_PLAYER),
    TA_EVENT_PLAYER_MOVE_BACKWARD,
    TA_EVENT_PLAYER_MOVE_RIGHT,
    TA_EVENT_PLAYER_MOVE_LEFT,
    TA_EVENT_PLAYER_MOVE_JUMP,
} ta_event_type;
