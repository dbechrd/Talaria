...
typedef enum ta_log_source {
    ...
    SRC_MATH       = 0x00002000,
    SRC_MODEL      = 0x00004000,
    SRC_OGX        = 0x00008000,
    SRC_OPENGL     = 0x00010000,
    SRC_PRIMITIVE  = 0x00020000,
    SRC_RENDER     = 0x00040000,
    SRC_RIGID_BODY = 0x00080000,
    SRC_SCENE      = 0x00100000,
    SRC_SHADER     = 0x00200000,
    SRC_SYSTEM     = 0x00400000,
    SRC_TEXTURE    = 0x00800000,
