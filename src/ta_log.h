...
typedef enum ta_log_source {
    ...
    SRC_GLTF       = 0x00000100,
    SRC_JSON       = 0x00000200,
    SRC_LIGHT      = 0x00000400,
    SRC_MATH       = 0x00000800,
    SRC_OPENGL     = 0x00001000,
    SRC_PRIMITIVE  = 0x00002000,
    SRC_RENDER     = 0x00004000,
    SRC_RIGID_BODY = 0x00008000,
    SRC_SCENE      = 0x00010000,
    SRC_SHADER     = 0x00020000,
    SRC_SYSTEM     = 0x00040000,
    SRC_TEXTURE    = 0x00080000,
    SRC_WINDOW     = 0x00100000,

    //...
    //SRC_LAST              = 0x8fffffff

    SRC_ALL = SRC_ASSERT | SRC_AUDIO | SRC_CONSOLE| SRC_EDITOR | SRC_EVENT | SRC_FILE | SRC_FONT | SRC_GAME | SRC_GLTF
            | SRC_JSON | SRC_LIGHT | SRC_MATH | SRC_OPENGL | SRC_PRIMITIVE | SRC_RENDER | SRC_RIGID_BODY | SRC_SCENE
            | SRC_SHADER | SRC_SYSTEM | SRC_TEXTURE | SRC_WINDOW
} ta_log_source;
