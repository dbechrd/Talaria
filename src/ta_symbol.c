...
const char *SYM_U_MATERIAL_ALBEDO_TEXTURE;
const char *SYM_U_MATERIAL_ALBEDO_FACTOR;
const char *SYM_U_MATERIAL_EMISSION_TEXTURE;
const char *SYM_U_MATERIAL_EMISSION_FACTOR;
const char *SYM_U_MATERIAL_METALLIC_TEXTURE;
const char *SYM_U_MATERIAL_METALLIC_FACTOR;
const char *SYM_U_MATERIAL_ROUGHNESS_TEXTURE;
const char *SYM_U_MATERIAL_ROUGHNESS_FACTOR;
const char *SYM_U_MATERIAL_HEIGHT_TEXTURE;
const char *SYM_U_MATERIAL_HEIGHT_FACTOR;
const char *SYM_U_MATERIAL_NORMAL_TEXTURE;
const char *SYM_U_MATERIAL_OCCLUSION_TEXTURE;
...
void ta_symbol_init() {
    ...
    SYM_U_MATERIAL_ALBEDO_TEXTURE    = INTERN("u_material.albedo_texture");
    SYM_U_MATERIAL_ALBEDO_FACTOR     = INTERN("u_material.albedo_factor");
    SYM_U_MATERIAL_EMISSION_TEXTURE  = INTERN("u_material.emission_texture");
    SYM_U_MATERIAL_EMISSION_FACTOR   = INTERN("u_material.emission_factor");
    SYM_U_MATERIAL_METALLIC_TEXTURE  = INTERN("u_material.metallic_texture");
    SYM_U_MATERIAL_METALLIC_FACTOR   = INTERN("u_material.metallic_factor");
    SYM_U_MATERIAL_ROUGHNESS_TEXTURE = INTERN("u_material.roughness_texture");
    SYM_U_MATERIAL_ROUGHNESS_FACTOR  = INTERN("u_material.roughness_factor");
    SYM_U_MATERIAL_HEIGHT_TEXTURE    = INTERN("u_material.height_texture");
    SYM_U_MATERIAL_HEIGHT_FACTOR     = INTERN("u_material.height_factor");
    SYM_U_MATERIAL_NORMAL_TEXTURE    = INTERN("u_material.normal_texture");
    SYM_U_MATERIAL_OCCLUSION_TEXTURE = INTERN("u_material.occlusion_texture");
